...
- shows a compact authoritative status badge (`INTERCEPTING`, `REJECTED`, `ASSESSED`, `LIVE`, etc.) in the header instead of burying long status text in panel body content
